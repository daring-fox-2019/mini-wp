...
router.get('/all', authenticate, ArticleController.findFromAllUsers)
...
router.put('/:id',authenticate, authorizedUser, images.multer.single('image'), images.sendUploadToGCS, generateTag, authorizedUser, ArticleController.update)
