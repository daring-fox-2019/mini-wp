...
{/* <div>
        <div class="border container" style="background: url('./assets/nevermiss.png')" ; padding:40px;">
            <div class="row">
                <div class="col"></div>
                <div class="col-6">
                    <form @submit.prevent=login>
                        ...
                        <div class="form-group">
                            <label for="loginEmail">Email address</label>
                            <input v-model="loginEmail" type="email" class="form-control" aria-describedby="emailHelp"
